"""GitHub Direct Upload Tool - Upload content directly to GitHub."""
...
def run(owner: str, repo: str, content: str, repo_path: str, message: str = "Upload content") -> Dict[str, Any]:
    ...
    headers = {
        ...
        "User-Agent": "MCP-GitHub-Direct/1.0"
    }
    ...
    return {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "required": ["owner", "repo", "content", "repo_path"],
